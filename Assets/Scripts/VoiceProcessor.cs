...
public static class VoiceProcessor
{
    ...
    /// </summary>
    public static event Action<short[]> OnFrameCaptured;

    /// <summary>
    /// Event when audio capture thread stops
    /// </summary>
    public static event Action OnRecordingStop;
    ...
    /// <summary>
    /// The minimum volume to detect voice input for
    /// </summary>
    private const float _minimumSpeakingSampleValue = 0.05f;

    /// <summary>
    /// Time in seconds of detected silence before voice request is sent
    /// </summary>
    private const float _silenceTimer = 1.0f;

    /// <summary>
    /// Auto detect speech using the volume threshold
    /// </summary>
    private static bool _autoDetect;

    private static float _timeAtSilenceBegan;
    private static bool _audioDetected;
    ...
    public static void StartRecording(int sampleRate = 16000, int frameSize = 512, bool autoDetect = false)
    {
