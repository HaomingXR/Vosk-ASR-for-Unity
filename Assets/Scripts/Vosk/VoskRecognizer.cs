namespace Vosk
{
    ...
    public class VoskRecognizer : System.IDisposable
    {
        ...
        public string Result() => PtrToStringUTF8(VoskPINVOKE.VoskRecognizer_Result(handle));

        public string PartialResult() => PtrToStringUTF8(VoskPINVOKE.VoskRecognizer_PartialResult(handle));
